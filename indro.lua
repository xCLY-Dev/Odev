...
gamelabel.Size = UDim2.new(0, 270, 0, 104)
gamelabel.Font = Enum.Font.Gotham
gamelabel.Text = _G.gamenamegay
gamelabel.TextColor3 = Color3.fromRGB(255, 255, 255)
gamelabel.TextSize = 25.000

local function YOOIZAY_fake_script() -- Frame.LocalScript 
	local script = Instance.new('LocalScript', Frame)

	wait(2)
	local gui = script.Parent
	local tween = gui:TweenSize(UDim2.new(0, 100,0, 100), Enum.EasingDirection.In,Enum.EasingStyle.Sine,0.2,true)
	wait(2)
	local tween = gui:TweenSize(UDim2.new(0, 300,0, 150), Enum.EasingDirection.In,Enum.EasingStyle.Sine,0.2,true)
	wait(4)
	local tween = gui:TweenSize(UDim2.new(0, 100,0, 100), Enum.EasingDirection.In,Enum.EasingStyle.Sine,0.2,true)
	wait(3)
	local tween = gui:TweenSize(UDim2.new(0, 0,0, 0), Enum.EasingDirection.In,Enum.EasingStyle.Sine,0.2,true)
	
end
coroutine.wrap(YOOIZAY_fake_script)()
local function PFLTO_fake_script() -- TextButton.LocalScript 
...
coroutine.wrap(PFLTO_fake_script)()
local function SVSDJ_fake_script() -- BAR.LocalScript 
	local script = Instance.new('LocalScript', BAR)

	local gui = script.Parent
	wait(4)
	local tween = gui:TweenSize(UDim2.new(0, 300,0, 27), Enum.EasingDirection.In,Enum.EasingStyle.Sine,0.2,true)
	wait(4)
	local tween = gui:TweenSize(UDim2.new(0, 0,0, 0), Enum.EasingDirection.In,Enum.EasingStyle.Sine,0.2,true)
	gui.Visible = false
	
end
coroutine.wrap(SVSDJ_fake_script)()
local function MVXKOB_fake_script() -- ImageLabel.LocalScript 
	...
	local tween = gui:TweenSize(UDim2.new(0, 100,0, 100), Enum.EasingDirection.In,Enum.EasingStyle.Sine,0.2,true)
	wait(2)
	local tween = gui:TweenSize(UDim2.new(0, 40,0, 40), Enum.EasingDirection.In,Enum.EasingStyle.Sine,0.2,true)
	wait(4)
	local tween = gui:TweenSize(UDim2.new(0, 100,0, 100), Enum.EasingDirection.In,Enum.EasingStyle.Sine,0.2,true)
	wait(3)
	local tween = gui:TweenSize(UDim2.new(0, 0,0, 0), Enum.EasingDirection.In,Enum.EasingStyle.Sine,0.2,true)
...
coroutine.wrap(MVXKOB_fake_script)()
local function DSJK_fake_script() -- TEXT.LocalScript 
	local script = Instance.new('LocalScript', TEXT)

	local gui = script.Parent
	wait(4)
	local tween = gui:TweenSize(UDim2.new(0, 270,0, 105), Enum.EasingDirection.In,Enum.EasingStyle.Sine,0.2,true)
	wait(4)
	local tween = gui:TweenSize(UDim2.new(0, 0,0, 0), Enum.EasingDirection.In,Enum.EasingStyle.Sine,0.2,true)
	gui.Visible = false
...
coroutine.wrap(DSJK_fake_script)()
